...
//  IconMaker
//
//  Created by 피터 on 2020/04/07.
//  Copyright © 2020 WEJOApps. All rights reserved.
//
...
class DragDropImageView: NSImageView {
    ...
    override func mouseDragged(with event: NSEvent) {
        ...
        let draggingImage = image.resizedImage(size, scale: 1)
//        if  {
...
extension DragDropImageView: NSDraggingSource {
